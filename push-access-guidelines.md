...
Modify the commit message to meet guidelines. At the very least you will want to add a Bug: line or Fixes (etc.). Examples: [3a5d5de](https://github.com/curl/curl/commit/3a5d5de) [8e176a7](https://github.com/curl/curl/commit/8e176a7)
