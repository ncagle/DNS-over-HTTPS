...
| [pi-dns.com](https://pi-dns.com) | https://doh.centraleu.pi-dns.com/dns-query https://doh.northeu.pi-dns.com/dns-query https://doh.westus.pi-dns.com/dns-query https://doh.eastus.pi-dns.com/dns-query | Public ad-blocking DNS service built on Pi-hole that support DNS over HTTPS (DoH) and DNS over TLS (DoT). |
