...
| **J**
| [jcdns.fun](https://jcdns.fun)| https://jcdns.fun/dns-query | :heavy_multiplication_x:| secure nginx, Non-Logged / Uncensored, hosted on Digital Ocean VPS by [jamesacampbell](https://github.com/jamesacampbell) AKA James Campbell. **DOES NOT SEEM TO BE WORKING (ANYMORE)** |
