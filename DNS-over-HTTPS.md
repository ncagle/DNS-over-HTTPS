...
|adghs.de|https://adghs.de/dns-query|:heavy_check_mark:|Ad & porn blocking
...
|artsvr.my.id|https://doh.artsvr.my.id/dns-query|:heavy_check_mark:|Adblocking
...
|chalkychalk.com|https://dns.chalkychalk.com/dns-query|:heavy_check_mark:|Adblocking
...
|cloudku.technology|https://voyage-s01.cloudku.technology/dns-query|:heavy_check_mark:|
...
| [dnscry.pt](https://www.dnscry.pt/) | Allentown: https://abe01.dnscry.pt/dns-query<br>Amsterdam Terrahost: https://ams01.dnscry.pt/dns-query<br>Amsterdam CrownCloud: https://ams02.dnscry.pt/dns-query<br>Chicago: https://ord01.dnscry.pt/dns-query<br>Coeur d'Alene: https://coe01.dnscry.pt/dns-query<br>Coventry: https://cvt01.dnscry.pt/dns-query<br>Dallas: https://dfw01.dnscry.pt/dns-query<br>Durham: https://rdu01.dnscry.pt/dns-query<br>Düsseldorf: https://dus01.dnscry.pt/dns-query<br>Frankfurt: https://fra01.dnscry.pt/dns-query<br>Fujairah: https://fjr01.dnscry.pt/dns-query<br>Hong Kong: https://hkg01.dnscry.pt/dns-query<br>Jakarta: https://jkt01.dnscry.pt/dns-query<br>Johannesburg: https://jnb01.dnscry.pt/dns-query<br>Lagos: https://los01.dnscry.pt/dns-query<br>Las Vegas: https://las01.dnscry.pt/dns-query<br>Liberty Lake: https://llk01.dnscry.pt/dns-query<br>London: https://lon01.dnscry.pt/dns-query<br>Los Angeles Webhosting24: https://lax01.dnscry.pt/dns-query<br>Los Angeles CrownCloud: https://lax02.dnscry.pt/dns-query<br>Miami: https://mia01.dnscry.pt/dns-query<br>Munich: https://muc01.dnscry.pt/dns-query<br>New York: https://nyc01.dnscry.pt/dns-query<br>Philadelphia: https://phl01.dnscry.pt/dns-query<br>Phoenix: https://phx01.dnscry.pt/dns-query<br>Salt Lake City: https://slc01.dnscry.pt/dns-query<br>Sandefjord: https://trf01.dnscry.pt/dns-query<br>Singapore: https://sin01.dnscry.pt/dns-query<br>Sofia: https://sof01.dnscry.pt/dns-query<br>Spokane: https://geg01.dnscry.pt/dns-query<br>Stockholm: https://sto01.dnscry.pt/dns-query<br>Tallinn: https://tll01.dnscry.pt/dns-query<br>Tampa: https://tpa01.dnscry.pt/dns-query<br>Warsaw Skhron: https://waw02.dnscry.pt/dns-query| :heavy_check_mark:| Support IPv4+IPv6, uncensored, unfiltered, encrypted, DNSSEC, no logging.
...
|fihch.ru|https://adguard.fihch.ru/dns-query|:heavy_check_mark:|Adblocking
|fknw.de|https://resolve.fknw.de/dns-query|:heavy_check_mark:|Adblocking
...
|[jungle-im](https://jungle-im.ir/)|https://dns.jungle-im.ir/dns-query|:heavy_check_mark:|Adblocking
...
|[Lahiru  Sandaruwan](https://itsnooblk.xyz/)|https://ddns.itsnooblk.xyz/dns-query|:heavy_check_mark:|Adblocking
...
| [Lista](https://lista.my.id/dns-lista-sudah-online-untuk-publik/) | https://dns.lista.my.id/dns-query | :heavy_check_mark: | DNSSEC + ECS + Adblocking
...
|mikatos.de|https://mikatos.de/dns-query|:heavy_check_mark:|
...
|myv2ray|https://myv2ray.cn/dns-query|:heavy_check_mark:|Adblocking
| **N**
...
|paskam.xyz|https://by.paskam.xyz/dns-query|:heavy_check_mark:|Adblocking
...
|trovs.ru|https://www.trovs.ru/dns-query|:heavy_check_mark:|Adblocking
