...
|coderoria.com|https://dns.coderoria.com/dns-query|:heavy_check_mark:|Block ads, use Cloudflare upstream and AdGuard browsing security web service. Also support DoT
...
|dnsadguard.co.uk|https://dns.dnsadguard.co.uk/dns-query|:heavy_check_mark:|Block ads, support DoT & DoQ
...
|[Morizt Id](https://morizt.id)|https://doh.morizt.id/dns-query|:heavy_check_mark:|Block ads, support DoT & DoQ
...
|sarak.as|https://dns.sarak.as/dns-query<br>https://dns.sarakas.net/dns-query|:heavy_check_mark:|Block ads & porn, use Cloudflare upstream with malware and family filtering, AdGuard browsing security and parental control web service, support DoT
