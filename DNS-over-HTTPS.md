...
| [AhaDNS.com](https://ahadns.com) | https://doh.nl.ahadns.net/dns-query <br> https://doh.in.ahadns.net/dns-query | :heavy_check_mark: | A zero logging DNS with support for DNS-over-HTTPS (DoH) & DNS-over-TLS (DoT). Blocks ads, malware, trackers, viruses and telemetry. DNSSEC, TLS 1.3, Open Source. |
