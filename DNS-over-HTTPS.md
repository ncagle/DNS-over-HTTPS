...
| ContainerPI | https://dns.containerpi.com/dns-query | Runs on [dns-over-https](https://github.com/m13253/dns-over-https), no logging, EDNS Client Subnet enabled, DNSSEC and adblock not currently enabled. Multiple nodes in China Mainland and Japan. |
