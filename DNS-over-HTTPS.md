...
| jitender| https://jit.ddns.net:2443/doh | :heavy_check_mark: | Hosted in Oracle Cloud, Hyderabad, India, runs with nginx, high availability, load balanced with backend DNS servers by nginx. Backend servers run pihole for ad blocking. @coolquasar |
