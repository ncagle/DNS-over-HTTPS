...
| [Adhole - SHUTTING DOWN](https://adhole.org/) | United Kingdom : https://uk.adhole.org/dns-query <br> Germany : https://de.adhole.org/dns-query <br> Singapore : https://sg.adhole.org/dns-query <br> US Central : https://us-central.adhole.org/dns-query <br> US East :  https://us-east.adhole.org/dns-query | :x: <br> :x: <br> :heavy_check_mark: <br> :x: <br> :x: | Adblocking with OISD list, queries and originating IP stored for 24 hours.
