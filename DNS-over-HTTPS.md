...
| [DNS.SB](https://dns.sb/doh/) | https://doh.dns.sb/dns-query | :heavy_check_mark: | DNSSEC & QNAME minimization enabled, no logging, also [support DoT](https://dns.sb/dot/) |
