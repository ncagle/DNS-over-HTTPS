...
| **B**
| [BebasDNS](https://github.com/bebasid/bebasdns) | Singapore Linode : https://doh.doh.my.id/dns-query <br> Singapore Digital Ocean : https://doh.kutu.my.id/dns-query <br> Indonesia Google Cloud Platform : https://id.terra.my.id/dns-query | :heavy_check_mark: <br> :heavy_check_mark: <br> :heavy_check_mark: | DNS-based ad-blocking service
...
| [DNSCepat](https://asia.dnscepat.id/dns-query) | Asia: https://asia.dnscepat.id/dns-query | :heavy_check_mark: | Non-filtering
...
| NekomimiRouter.com | https://dns.dns-over-https.com/dns-query | :heavy_multiplication_x: | Runs [Go implementation](https://github.com/m13253/dns-over-https). Does recursion itself with no upstream servers. Toy server may fail, please report if fails |
| **P**
...
| @chantra    | https://dns.dnsoverhttps.net/dns-query | :heavy_multiplication_x: | "toy server" which runs [doh-proxy](https://github.com/facebookexperimental/doh-proxy) |
...
| [ibksturm.synology.me](https://ibksturm.synology.me)| https://ibksturm.synology.me/dns-query | :heavy_multiplication_x: | doh-server (nginx - dnsproxy - unbound), DNSSEC / Non-Logged / Uncensored, OpenNIC and Root DNS-Zone Copy Hosted in Switzerland by ibksturm, aka Andreas Ziegler. |
|[@matthewgall - mydns.network](https://twitter.com/matthewgall) | https://adblock.mydns.network/dns-query (adblock, using unbound) | :heavy_check_mark: | DNSSEC / no logging / DDoS protected / anycast / blocks adverts, phishing and malware / updated daily|
