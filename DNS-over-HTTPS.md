...
|[DNSGuard.pub](https://dnsguard.pub)|https://dnsguard/dns-query|:heavy_check_mark:| Supports DoH DoT/DoQ and DNSCrypt, No logging, Own block list for Malware and tracking and ads
