...
|-------------|----------|---------|---------|
| **A**
|[aaflalo.me](https://www.aaflalo.me/2019/01/dns-over-https-server-aaflalo-me/) | Server US: https://dns-nyc.aaflalo.me/dns-query | :heavy_check_mark: | Runs on Star pBrilliant's [dns-over-https](https://github.com/m13253/dns-over-https) <br> Checks for DNSSEC and block advertising |
...
|[Andrews & Arnold](https://aa.net.uk/dnst) | https://dns.aa.net.uk/dns-query | :heavy_check_mark: | no logging (see [DNS Disclaimer](https://www.aa.net.uk/legal/dohdot-disclaimer/))|
...
| **O**
| [Open Internet](https://openinternet.io/) | https://resolver4.dns.openinternet.io/dns-query | :heavy_check_mark: | No log, no filter, DNSSEC
| **P**
