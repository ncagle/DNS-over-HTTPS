...
|connect.fail|https://dns.connect.fail/dns-query|:heavy_check_mark:|Block ads
...
|[Cooluc's DNS](https://dns.cooluc.com)|https://dns.cooluc.com/dns-query|:heavy_check_mark:|
