...
|-------------|----------|---------|---------|
| **A**
|[ABD](https://abd.ong/)|https://adguard.abd.ong/dns-query|:heavy_check_mark:|Adblocking, use Cloudflare upstream with malware filtering
...
|btb.dog/|https://btb.dog/|:heavy_check_mark:|
...
|circumitor.de|https://m-cm.circumitor.de/dns-query|:heavy_check_mark:|Block ads & gambling, use AdGuard browsing security web service
...
|[CongNT](https://doh.ntcong.it)|https://doh.ntcong.it/dns-query|:heavy_check_mark:|Block ads, use Cloudflare upstream
...
|jtcargokebumen.com|https://doh.jtcargokebumen.com/dns-query|:heavy_check_mark:|Block ads
...
|uni5wap.info|https://uni5wap.info/dns-query|:heavy_check_mark:|
| **V**
